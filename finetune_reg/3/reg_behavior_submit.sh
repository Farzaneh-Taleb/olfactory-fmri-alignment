...
echo "sbatch --array=0-$((total_jobs - 1)) pdc_regresion_behavior_run_job.sh"
sbatch --array=0-$((total_jobs - 1)) pdc_regresion_behavior_run_job.sh
# sbatch --array=0-0 pdc_regresion_behavior_run_job.sh
