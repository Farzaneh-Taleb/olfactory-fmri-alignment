...
from utils.data_loader import load_model_embeddings, load_fold_cids
...
def main():
    ...
    # Output path setup
    out_base = Path(BASE_DIR) / f"{out_dir}_fmri_metrics"
    ...
    for layer in range(1, LAYERS_END[m] + 1):
        ...
        for i_fold in range(n_fold):
            ...
            metrics = compute_correlation(
                train_embeddings, fmri_train, test_embeddings, fmri_test,
