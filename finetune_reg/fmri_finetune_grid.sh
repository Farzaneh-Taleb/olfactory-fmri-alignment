...
behavior_embeddings=("" "intensity" "pleasantness" "intensity, pleasantness")       # empty string => use default behavior columns inside your script
unfreeze_layers=(1 2 3 4 5 6 -1)
