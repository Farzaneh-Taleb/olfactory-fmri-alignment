...
def find_slurmstepd_errors(directory="./logs"):
    ...
    error_files = [f for f in os.listdir(directory) if f.endswith(".err")]
    ...
    for filename in error_files:
        ...
        try:
            with open(filepath, "r") as file:
                content = file.read()
                # if "TR: 5" in content and "ROI: OFC" in content and 'Components: 30' in content and 'Model: ChemBERT_ChEMBL_pretrained' in content:
                if 'Err' in content:
